...
PlayerEvents.loggedIn(e => {
    e.server.singleplayer
    if (!e.hasGameStage('starter_items')) {
        e.addGameStage('starter_items')
        if (!e.server.singleplayer) e.player.tell(Text.red('Hey! Looks like its your first time joining. Please re-log to fix some problems with the first join. Sorry for the inconvenience!'))
        e.player.addItem(
