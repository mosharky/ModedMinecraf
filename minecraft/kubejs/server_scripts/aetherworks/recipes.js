function recipes_Aetherworks(e) {
    ...
    e.custom({
        ...
        result: [
            ...
            { chance: 10, count: 1, item: 'caverns_and_chasms:raw_silver' },
    ...
    e.custom({
        ...
        result: [
            ...
            { chance: 5, count: 1, item: 'caverns_and_chasms:raw_silver' },
    ...
    e.custom({
        ...
        result: [
            ...
            { chance: 5, count: 1, item: 'caverns_and_chasms:raw_silver_block' },
