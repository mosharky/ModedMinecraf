...
function origins_Dwarf(e) {
    ...
    e.addJson('kubejs:origins/cave_dwarf', {
        name: 'Cave Dwarf',
        description: 'An engineer of age; a tinkerer of grandiose; a smith of greatness: A Cave Dwarf. Made exclusively for ME',
    ...
    // darkvision
    e.addJson('kubejs:powers/cave_dwarf/darkvision', {
        name: 'Darkvision',
    ...
    // cave dweller
    e.addJson('kubejs:powers/cave_dwarf/cave_dweller', {
        name: 'Cave Dweller',
    ...
    // bear love
    e.addJson('kubejs:powers/cave_dwarf/ursus_family', {
        name: 'Ursus Family',
        badges: [{
    ...
    // short legged
    e.addJson('kubejs:powers/cave_dwarf/short_legged', {
        name: 'Short Legged',
    ...
    // dwarven engineering
    e.addJson('kubejs:item_modifiers/dwarven_lore', [
        {
    ...
    e.addJson('kubejs:powers/cave_dwarf/dwarven_smithing', {
    ...
    e.addJson('kubejs:powers/cave_dwarf/light_deterioration', {
        ...
        shader_at_max: {
            type: 'origins:shader',
            shader: 'minecraft:shaders/post/phosphor',
            toggleable: true,
            condition: {
                type: 'origins:resource',
                resource: '*:*_debuff',
    ...
    e.addJson('kubejs:powers/cave_dwarf/grand_equipment', {
