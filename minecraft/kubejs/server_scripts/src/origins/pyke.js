...
function origins_Pyke(e) {
    // init
    e.addJson('kubejs:origins/pyke', {
        name: 'Pyke',
        description: 'A renowned harpooner from the slaughter docks of Bilgewater. Made exclusively for Anya/pykelover/Nyakiichan/AMF/STUPID DUMB IDIOT!!!!!!!!',
        icon: 'alexsmobs:skelewag_sword',
        powers: [
    ...
    // Phantasmal
    e.addJson('kubejs:powers/pyke/phantasmal', {
        name: 'Phantasmal',
    ...
    // Soggy Strength
    e.addJson('kubejs:powers/pyke/soggy_strength', {
        name: 'Soggy Strength',
    ...
    // Bone Skewer
    e.addJson('kubejs:powers/pyke/bone_skewer', {
        name: 'Bone Skewer',
        description: 'Pull a target within 12m towards you. The Skelewag\'s Skull deals twice as much damage.',
        badges: [
            {
                type: 'origins:tooltip',
                sprite: 'origins:textures/gui/badge/info.png',
        ...
        skelewag_sword_damage: {
            ...
            condition: {
                ...
                item_condition: {
                    ...
                    ingredient: Ingredient.of('alexsmobs:skelewag_sword').toJson()
                }
            }
        },
        pull: {
    ...
    e.addJson('kubejs:powers/pyke/bloodthirst', {
        type: 'origins:simple',
        name: 'Bloodthirst',
    ...
    e.addJson('kubejs:powers/pyke/ghostwater_dive', {
        ...
        // tier_2_shader: {
        //     type: 'origins:shader',
        //     shader: 'minecraft:shaders/post/desaturate',
        //     condition: {
        //         type: 'origins:resource',
        //         resource: '*:*_tier_2_resource',
        //         comparison: '==',
